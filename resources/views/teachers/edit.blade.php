...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8 px-6">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Update teacher information in the system</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="border-b border-gray-200 bg-gray-50 px-6 py-4">
                <h2 class="text-lg font-semibold text-gray-800 flex items-center">
                    <i class="fa fa-edit text-amber-500 mr-2"></i> Edit Teacher Information
                </h2>
            </div>

            <!-- Form -->
            <form action="{{ route('teachers.update', $teachers->id) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="subject" 
                        id="subject"
                        value="{{ old('subject', $teachers->subject) }}"
                        placeholder="Enter subject taught"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 @error('subject') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror"
                    >
                    @error('subject')
                        <div class="flex items-center mt-2 text-sm text-red-600">
                            <i class="fa fa-exclamation-circle mr-1.5"></i>
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200 @error('email') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror"
                    >
                    @error('email')
                        <div class="flex items-center mt-2 text-sm text-red-600">
                            <i class="fa fa-exclamation-circle mr-1.5"></i>
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="mobile" 
                        id="mobile"
                        value="{{ old('mobile', $teachers->mobile) }}"
                ...
                <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-6 border-t border-gray-200">
                    ...
                    >
                        <i class="fa fa-save mr-2"></i> Update Teacher
                    </button>
                </div>
            </form>
        </div>
